...
Edit the settings in 'cassandra.yaml' file:</br>
    ...
    margin: 0 auto;" align="left" src="https://github.com/jun159/Team3-Cassandra/blob/master/IMG%20CS4224.jpg" width="400"></br>
     <p>2) Listen: Add in the IP address of the current node in use.</p>
